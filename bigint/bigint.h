...
public:
    ...
    bigint(const char*);//used to initiailize bigint to a provide char
    ...
    friend std::ostream& operator<<(std::ostream& out, const bigint&);//overloaded output operator for printing bigints
